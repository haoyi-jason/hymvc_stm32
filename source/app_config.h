...
#define PROEUCT_CODE    0x21081000
#define REVISION_NUMBER 0x01000100
...
#define EV_PID_STATE_ERROR_AZ   EVENT_MASK(8)
#define EV_PID_STATE_ERROR_EL   EVENT_MASK(9)
#define EV_STOW_ACTION_DONE     EVENT_MASK(10)
#define EV_STOW_ACTION_FAIL     EVENT_MASK(11)
#define EV_STOW_CONTROL         EVENT_MASK(12)
...
#define EV_PID_EL_STARTED          EVENT_MASK(19)
#define EV_PID_EL_STOPPED          EVENT_MASK(20)
#define EV_ANT_STOW             EVENT_MASK(21)
#define EV_AZ_HOMESEARCHING     EVENT_MASK(22)
